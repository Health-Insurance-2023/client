              ...
              <div className='col-span-12 lg:col-span-4 2xl:col-span-7'>
                ...
                <div className='box p-5 rounded-md mt-3'>
                  ...
                  <div className='flex gap-2'>
                    {/*  */}
                    <button
                      disabled={userPayment.status !== 'unpaid'}
                  ...
                  <div className='mt-4 text-red-700 font-bold'>Lưu ý:</div>
                  <span>
                    - Nếu hết hạn mà chưa thanh toán thì đơn đăng ký sẽ không được phát hành hợp đồng bảo hiểm
                  </span>
                  <div>
                    - Trường hợp bạn muốn thanh toán bằng tiền mặt vui lòng liên hên với chúng tôi qua số điện thoại{' '}
                    <span className='italic font-bold'>+84 345 678910</span> hoặc đến trực tiếp công ty
                  </div>
                </div>
              </div>
              ...
              <div className='col-span-12 lg:col-span-7 2xl:col-span-5'>
                ...
                {userPayment.status === 'unpaid' && (
                  <button
                    onClick={() => {
                      handleOpen()
                      payBill({ body: { method: paymentMethod }, id: userPayment.id })
                    }}
